...
public class HintsViewController {
    private final ClassRepository classRepository;
    private final OpponentService opponentService;
    private final Logger logger = LoggerFactory.getLogger(HintsViewController.class);


    public HintsViewController(ClassRepository classRepository, OpponentService opponentService) {
    ...
    public ModelAndView showClass(
        ...
        logger.info("[hints/hints_main] classUTs found: {}", classUTList);
        ModelAndView view = new ModelAndView("hints/hints_main");
